    ...
    return {
      onClick: event => {this.goToMatch(record.MatchId)}, // clicking a row takes the user to a detailed view of the match in the /matches page using the MatchId parameter  
            ...
            <ColumnGroup title="Goals">
             ...
             <Column title="HomeGoals" dataIndex="HomeGoals" key="HomeGoals" sorter= {(a, b) => a.HomeGoals.toString().localeCompare(b.HomeGoals.toString())}/>
              <Column title="AwayGoals" dataIndex="AwayGoals" key="AwayGoals" sorter= {(a, b) => a.AwayGoals.toString().localeCompare(b.AwayGoals.toString())}/>
            </ColumnGroup>
