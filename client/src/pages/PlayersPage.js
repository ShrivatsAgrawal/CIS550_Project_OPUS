    ...
    render() {
        return (
            ...
            <div>
                ...
                <Table dataSource={this.state.playersResults} style={{ width: '70vw', margin: '0 auto', marginTop: '2vh' }} columns={playerColumns} pagination={{ pageSizeOptions:[5, 10], defaultPageSize: 5, showQuickJumper:true }}/>
                <Divider />
                        ...
                        <CardBody>
                            ...
                            <h6>Best Rating</h6>
                                ...
                                domains={[
                                    ...
                                    { name: 'Handling', domain: [0, 100], getValue: d => d.GKDiving },
